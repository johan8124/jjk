## Description
SAT0RU is a cursed technique visualizer based on the popular anime series, Jujutsu Kaisen. It combines the mediapipe library with three.js to recreate cursed techniques from Jujutsu Kaisen. Powered by Gemini 3.

FOLLOW https://github.com/johan8124 FOR MORE.
...
### Installation
1.  **Clone the repo** ([github.com/johan8124/jjk](https://github.com/johan8124/jjk))
    ```bash
    git clone https://github.com/johan8124/jjk.git
    cd jjk
    ```
...
This project was built and powered by **Google Gemini 3 and Claude.ai**.
